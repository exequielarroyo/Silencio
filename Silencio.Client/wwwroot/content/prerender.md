...
[Header](https://github.com/NetCoreTemplates/blazor-tailwind/blob/main/Silencio.Client/Shared/Header.razor),
[Sidebar](https://github.com/NetCoreTemplates/blazor-tailwind/blob/main/Silencio.Client/Shared/Sidebar.razor) and
[MainLayout](https://github.com/NetCoreTemplates/blazor-tailwind/blob/main/Silencio.Client/Shared/MainLayout.razor) 
and paste it into 
[/wwwroot/index.html](https://github.com/NetCoreTemplates/blazor-tailwind/blob/main/Silencio.Client/wwwroot/index.html)
...
[PrerenderTasks.cs](https://github.com/NetCoreTemplates/blazor-tailwind/blob/main/Silencio.Tests/PrerenderTasks.cs)
with the `prerender` Test category. The only configuration the tasks require is the location of the `ClientDir` WASM Project 
defined in [appsettings.json](https://github.com/NetCoreTemplates/blazor-tailwind/blob/main/Silencio.Tests/appsettings.json) 
...
```xml
<PropertyGroup>
    <TestsDir>$(MSBuildProjectDirectory)/../Silencio.Tests</TestsDir>
</PropertyGroup>
...
[<Loading/>](https://github.com/NetCoreTemplates/blazor-tailwind/blob/main/Silencio.Client/Shared/Loading.razor) component
...
[Docs.razor](https://github.com/NetCoreTemplates/blazor-tailwind/blob/main/Silencio.Client/Pages/Docs.razor).
...
[content](https://github.com/NetCoreTemplates/blazor-tailwind/tree/main/Silencio.Client/wwwroot/content)
directory and uses the same
[/Silencio.Client/MarkdownUtils.cs](https://github.com/NetCoreTemplates/blazor-tailwind/blob/main/Silencio.Client/MarkdownUtils.cs)
implementation [Docs.razor](https://github.com/NetCoreTemplates/blazor-tailwind/blob/main/Silencio.Client/Pages/Docs.razor)
