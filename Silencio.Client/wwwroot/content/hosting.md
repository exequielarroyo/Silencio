...
##  [/Silencio.Client](https://github.com/NetCoreTemplates/blazor-tailwind/tree/main/Silencio.Client)
...
## [/Silencio](https://github.com/NetCoreTemplates/blazor-tailwind/tree/main/Silencio)

The .NET 6 `/Silencio` backend server is required for this App's dynamic functions including the Hello API on the home page
